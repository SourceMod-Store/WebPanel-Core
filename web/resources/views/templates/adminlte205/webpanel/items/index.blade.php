                ...
                <div class="box-body">
                    <table class="table table-bordered">
                        ...
                        @foreach($items as $item)
                            <tr>
                                <td><a href="{{ route('webpanel.items.edit', array($item->id)) }}">{{$item->id}}</a></td>
                                <td>{{$item->priority}}</td>
                                <td>{{$item->name}}</td>
                                ...
                                <td>
                                    <div>
                                        <div style="float: right">
                                            {!! Form::open(['method' => 'DELETE', 'url' => route('webpanel.items.destroy',$item->id)]) !!}
                                            {!! Form::submit('Remove',['class' => 'btn btn-danger']) !!}
                                            {!! Form::close() !!}
                                        </div>
                                        <div style="float: right">
                                            {!! Form::open(['method' => 'GET', 'url' => route('webpanel.items.edit',$item->id)]) !!}
