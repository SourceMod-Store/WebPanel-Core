# WebPanel-Core Individual Contributor Assignment Agreement


Thank you for your interest in contributing to WebPanel-Core ("We" or "Us").

This contributor agreement ("Agreement") documents the rights granted by contributors to Us. To make this document effective, please sign it and send it to Us by electronic submission, following the instructions at https://www.clahub.com/agreements/SourceMod-Store/WebPanel-Core. This is a legally binding document, so please read it carefully before agreeing to it. The Agreement may cover more than one software project managed by Us.
...
(d) You have followed the instructions in http://LINK-TO-INFO, if You do not own the Copyright in the entire work of authorship Submitted.
